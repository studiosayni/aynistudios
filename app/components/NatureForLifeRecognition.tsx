...
export default function NatureForLifeRecognition({ showFilmLink = true, showLogos = true }: { showFilmLink?: boolean; showLogos?: boolean }) {
  return (
    <section className="nature-recognition editorial-grid section-space border-t border-[#28363a]">
      <div>
        ...
        {showLogos && <div className="nature-recognition-logos mt-8">
