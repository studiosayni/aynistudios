...
// Widths generated by scripts/build-hero-variants.py — keep in sync.
...
// with no srcset at all and every device downloads the full 1920px JPEG. These
// pre-built WebP variants deliver real responsive sizing independent of the
// host; the original .jpg stays as the src fallback.
const heroSrcSet = (base: string) =>
  HERO_WIDTHS.map((w) => `${base}-${w}.webp ${w}w`).join(", ");
